...
//  FoodPinApp
//
//  Created by Tiara H on 24/10/22.
//
...
class RestaurantsViewModel {
    ...
    func restaurantDescription(at index: Int) -> String {
        return restaurants[index].description
    }
    
    func restaurantPhone(at index: Int) -> String {
        return restaurants[index].phone
    }
    
    func restaurantLatitude(at index: Int) -> Double {
        return restaurants[index].latitude
    }
    
    func restaurantLongitude(at index: Int) -> Double {
        return restaurants[index].longitude
    }
    ...
    func addRestaurant(name: String, category: String, address: String, phone: String, description: String, thumb: UIImage, latitude: Double, longitude: Double) {
        let restaurant = Restaurant(name: name, category: category, address: address, phone: phone, description: description, thumb: thumb, latitude: latitude, longitude: longitude)
